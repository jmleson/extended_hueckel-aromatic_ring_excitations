...
\begin{itemize}
\item SALC of B2g: \quad $\frac{p_{1}}{6} - \frac{p_{2}}{6} + \frac{p_{3}}{6} - \frac{p_{4}}{6} + \frac{p_{5}}{6} - \frac{p_{6}}{6}$
\item SALC of E1g: \quad $\frac{p_{1}}{6} + \frac{p_{2}}{12} - \frac{p_{3}}{12} - \frac{p_{4}}{6} - \frac{p_{5}}{12} + \frac{p_{6}}{12}$
\item SALC of E1g: \quad $\frac{p_{2}}{4} + \frac{p_{3}}{4} - \frac{p_{5}}{4} - \frac{p_{6}}{4}$
\item SALC of A2u: \quad $\frac{p_{1}}{6} + \frac{p_{2}}{6} + \frac{p_{3}}{6} + \frac{p_{4}}{6} + \frac{p_{5}}{6} + \frac{p_{6}}{6}$
\item SALC of E2u: \quad $\frac{p_{1}}{6} - \frac{p_{2}}{12} - \frac{p_{3}}{12} + \frac{p_{4}}{6} - \frac{p_{5}}{12} - \frac{p_{6}}{12}$
\item SALC of E2u: \quad $\frac{p_{2}}{4} - \frac{p_{3}}{4} + \frac{p_{5}}{4} - \frac{p_{6}}{4}$
\end{itemize}
...
\begin{itemize}
\item SALC of A1g: \quad $\frac{s_{1}}{6} + \frac{s_{2}}{6} + \frac{s_{3}}{6} + \frac{s_{4}}{6} + \frac{s_{5}}{6} + \frac{s_{6}}{6}$
\item SALC of E2g: \quad $\frac{s_{1}}{6} - \frac{s_{2}}{12} - \frac{s_{3}}{12} + \frac{s_{4}}{6} - \frac{s_{5}}{12} - \frac{s_{6}}{12}$
\item SALC of E2g: \quad $\frac{s_{2}}{4} - \frac{s_{3}}{4} + \frac{s_{5}}{4} - \frac{s_{6}}{4}$
\item SALC of B1u: \quad $\frac{s_{1}}{6} - \frac{s_{2}}{6} + \frac{s_{3}}{6} - \frac{s_{4}}{6} + \frac{s_{5}}{6} - \frac{s_{6}}{6}$
\item SALC of E1u: \quad $\frac{s_{1}}{6} + \frac{s_{2}}{12} - \frac{s_{3}}{12} - \frac{s_{4}}{6} - \frac{s_{5}}{12} + \frac{s_{6}}{12}$
\item SALC of E1u: \quad $\frac{s_{2}}{4} + \frac{s_{3}}{4} - \frac{s_{5}}{4} - \frac{s_{6}}{4}$
\end{itemize}
Put together these SALCs form the following Hamilton matrices:
...
$$E_{dispersion} =\frac{2 \delta^{4} \left(- 9 \left(\alpha - \alpha_{s}\right) \left(\alpha - \alpha_{s} - \beta + \beta_{s}\right) - \left(\alpha - \alpha_{s}\right) \left(\alpha - \alpha_{s} + \beta - \beta_{s}\right) - 6 \left(\alpha - \alpha_{s} - \beta + \beta_{s}\right) \left(\alpha - \alpha_{s} + \beta - \beta_{s}\right)\right)}{r^{6} \left(\alpha - \alpha_{s}\right) \left(\alpha - \alpha_{s} - \beta + \beta_{s}\right) \left(\alpha - \alpha_{s} + \beta - \beta_{s}\right)}$$
\end{enumerate}
Error in Calculations Dispersion can only concatenate list (not "str") to list
