...
$$\mathsf{\Gamma}_{red} = \,6 E\;\oplus{}\,-2 C'2\;\oplus{}\,-6 \sigma h\;\oplus{}\,2 \sigma v\;$$
...
Put together these SALCs form the following Hamilton matrices:
     $$ H_{B2g}= \left[\begin{bmatrix}\tilde{\alpha} - 2 \tilde{\beta}\end{bmatrix}\right]$$ 
     $$ H_{E1g}= \left[\begin{bmatrix}\tilde{\alpha} + \tilde{\beta} & 0\\0 & \tilde{\alpha} + \tilde{\beta}\end{bmatrix}\right]$$ 
     $$ H_{A2u}= \left[\begin{bmatrix}\tilde{\alpha} + 2 \tilde{\beta}\end{bmatrix}\right]$$ 
     $$ H_{E2u}= \left[\begin{bmatrix}\tilde{\alpha} - \tilde{\beta} & 0\\0 & \tilde{\alpha} - \tilde{\beta}\end{bmatrix}\right]$$ 
...
( 
$$
\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A2u}\end{array}\right] = \left[\begin{matrix}1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{p}_{1}}{6} + \frac{\sqrt{6} \text{p}_{2}}{6} + \frac{\sqrt{6} \text{p}_{3}}{6} + \frac{\sqrt{6} \text{p}_{4}}{6} + \frac{\sqrt{6} \text{p}_{5}}{6} + \frac{\sqrt{6} \text{p}_{6}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\text{p}_{2}}{2} + \frac{\text{p}_{3}}{2} - \frac{\text{p}_{5}}{2} - \frac{\text{p}_{6}}{2}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\text{p}_{2}}{2} + \frac{\text{p}_{3}}{2} - \frac{\text{p}_{5}}{2} - \frac{\text{p}_{6}}{2}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\text{p}_{2}}{2} - \frac{\text{p}_{3}}{2} + \frac{\text{p}_{5}}{2} - \frac{\text{p}_{6}}{2}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{3} \left(2 \text{p}_{1} - \text{p}_{2} - \text{p}_{3} + 2 \text{p}_{4} - \text{p}_{5} - \text{p}_{6}\right)}{6} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\text{p}_{2}}{2} - \frac{\text{p}_{3}}{2} + \frac{\text{p}_{5}}{2} - \frac{\text{p}_{6}}{2}\end{matrix}\right] 
 $$ $$ = \frac{\text{p}_{2}}{2} - \frac{\text{p}_{3}}{2} + \frac{\text{p}_{5}}{2} - \frac{\text{p}_{6}}{2} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B2g}\end{array}\right] = \left[\begin{matrix}1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{p}_{1}}{6} - \frac{\sqrt{6} \text{p}_{2}}{6} + \frac{\sqrt{6} \text{p}_{3}}{6} - \frac{\sqrt{6} \text{p}_{4}}{6} + \frac{\sqrt{6} \text{p}_{5}}{6} - \frac{\sqrt{6} \text{p}_{6}}{6}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(\text{p}_{1} - \text{p}_{2} + \text{p}_{3} - \text{p}_{4} + \text{p}_{5} - \text{p}_{6}\right)}{6} 
 $$ 
 )
...
\end{itemize}
Put together these SALCs form the following Hamilton matrices:
     $$ H_{A1g}= \left[\begin{bmatrix}\tilde{\alpha}_{s} + 2 \tilde{\beta}_{s}\end{bmatrix}\right]$$ 
     $$ H_{E2g}= \left[\begin{bmatrix}\tilde{\alpha}_{s} - \tilde{\beta}_{s} & 0\\0 & \tilde{\alpha}_{s} - \tilde{\beta}_{s}\end{bmatrix}\right]$$ 
     $$ H_{B1u}= \left[\begin{bmatrix}\tilde{\alpha}_{s} - 2 \tilde{\beta}_{s}\end{bmatrix}\right]$$ 
     $$ H_{E1u}= \left[\begin{bmatrix}\tilde{\alpha}_{s} + \tilde{\beta}_{s} & 0\\0 & \tilde{\alpha}_{s} + \tilde{\beta}_{s}\end{bmatrix}\right]$$ 
...
( 
$$
\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A1g}\end{array}\right] = \left[\begin{matrix}1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{s}_{1}}{6} + \frac{\sqrt{6} \text{s}_{2}}{6} + \frac{\sqrt{6} \text{s}_{3}}{6} + \frac{\sqrt{6} \text{s}_{4}}{6} + \frac{\sqrt{6} \text{s}_{5}}{6} + \frac{\sqrt{6} \text{s}_{6}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\text{s}_{2}}{2} + \frac{\text{s}_{3}}{2} - \frac{\text{s}_{5}}{2} - \frac{\text{s}_{6}}{2}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\text{s}_{2}}{2} + \frac{\text{s}_{3}}{2} - \frac{\text{s}_{5}}{2} - \frac{\text{s}_{6}}{2}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\text{s}_{2}}{2} - \frac{\text{s}_{3}}{2} + \frac{\text{s}_{5}}{2} - \frac{\text{s}_{6}}{2}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{3} \left(2 \text{s}_{1} - \text{s}_{2} - \text{s}_{3} + 2 \text{s}_{4} - \text{s}_{5} - \text{s}_{6}\right)}{6} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\text{s}_{2}}{2} - \frac{\text{s}_{3}}{2} + \frac{\text{s}_{5}}{2} - \frac{\text{s}_{6}}{2}\end{matrix}\right] 
 $$ $$ = \frac{\text{s}_{2}}{2} - \frac{\text{s}_{3}}{2} + \frac{\text{s}_{5}}{2} - \frac{\text{s}_{6}}{2} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B1u}\end{array}\right] = \left[\begin{matrix}1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{s}_{1}}{6} - \frac{\sqrt{6} \text{s}_{2}}{6} + \frac{\sqrt{6} \text{s}_{3}}{6} - \frac{\sqrt{6} \text{s}_{4}}{6} + \frac{\sqrt{6} \text{s}_{5}}{6} - \frac{\sqrt{6} \text{s}_{6}}{6}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(\text{s}_{1} - \text{s}_{2} + \text{s}_{3} - \text{s}_{4} + \text{s}_{5} - \text{s}_{6}\right)}{6} 
 $$ 
 )
