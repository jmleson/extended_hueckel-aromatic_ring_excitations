...
\item orbital of A2u with energy = $\alpha + 2 \beta$ \\
                            ( $\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A2u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{6} p_{1}}{6} + \frac{\sqrt{6} p_{2}}{6} + \frac{\sqrt{6} p_{3}}{6} + \frac{\sqrt{6} p_{4}}{6} + \frac{\sqrt{6} p_{5}}{6} + \frac{\sqrt{6} p_{6}}{6}\end{matrix}\right] $ )
\item orbital of E1g with energy = $\alpha + \beta$ \\
                            ( $\left[\begin{matrix}1\\0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3} p_{1}}{3} + \frac{\sqrt{3} p_{2}}{6} - \frac{\sqrt{3} p_{3}}{6} - \frac{\sqrt{3} p_{4}}{3} - \frac{\sqrt{3} p_{5}}{6} + \frac{\sqrt{3} p_{6}}{6}\end{matrix}\right] $ )
\item orbital of E1g with energy = $\alpha + \beta$ \\
                            ( $\left[\begin{matrix}0\\1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g}\end{array}\right] = \left[\begin{matrix}\frac{p_{2}}{2} + \frac{p_{3}}{2} - \frac{p_{5}}{2} - \frac{p_{6}}{2}\end{matrix}\right] $ )
\item orbital of E2u with energy = $\alpha - \beta$ \\
                            ( $\left[\begin{matrix}1\\0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3} p_{1}}{3} - \frac{\sqrt{3} p_{2}}{6} - \frac{\sqrt{3} p_{3}}{6} + \frac{\sqrt{3} p_{4}}{3} - \frac{\sqrt{3} p_{5}}{6} - \frac{\sqrt{3} p_{6}}{6}\end{matrix}\right] $ )
\item orbital of E2u with energy = $\alpha - \beta$ \\
                            ( $\left[\begin{matrix}0\\1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u}\end{array}\right] = \left[\begin{matrix}\frac{p_{2}}{2} - \frac{p_{3}}{2} + \frac{p_{5}}{2} - \frac{p_{6}}{2}\end{matrix}\right] $ )
\item orbital of B2g with energy = $\alpha - 2 \beta$ \\
                            ( $\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B2g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{6} p_{1}}{6} - \frac{\sqrt{6} p_{2}}{6} + \frac{\sqrt{6} p_{3}}{6} - \frac{\sqrt{6} p_{4}}{6} + \frac{\sqrt{6} p_{5}}{6} - \frac{\sqrt{6} p_{6}}{6}\end{matrix}\right] $ )
\end{itemize}
...
\item orbital of A1g with energy = $\alpha_{s} + 2 \beta_{s}$ \\
                            ( $\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A1g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{6} s_{1}}{6} + \frac{\sqrt{6} s_{2}}{6} + \frac{\sqrt{6} s_{3}}{6} + \frac{\sqrt{6} s_{4}}{6} + \frac{\sqrt{6} s_{5}}{6} + \frac{\sqrt{6} s_{6}}{6}\end{matrix}\right] $ )
\item orbital of E1u with energy = $\alpha_{s} + \beta_{s}$ \\
                            ( $\left[\begin{matrix}1\\0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3} s_{1}}{3} + \frac{\sqrt{3} s_{2}}{6} - \frac{\sqrt{3} s_{3}}{6} - \frac{\sqrt{3} s_{4}}{3} - \frac{\sqrt{3} s_{5}}{6} + \frac{\sqrt{3} s_{6}}{6}\end{matrix}\right] $ )
\item orbital of E1u with energy = $\alpha_{s} + \beta_{s}$ \\
                            ( $\left[\begin{matrix}0\\1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u}\end{array}\right] = \left[\begin{matrix}\frac{s_{2}}{2} + \frac{s_{3}}{2} - \frac{s_{5}}{2} - \frac{s_{6}}{2}\end{matrix}\right] $ )
\item orbital of E2g with energy = $\alpha_{s} - \beta_{s}$ \\
                            ( $\left[\begin{matrix}1\\0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3} s_{1}}{3} - \frac{\sqrt{3} s_{2}}{6} - \frac{\sqrt{3} s_{3}}{6} + \frac{\sqrt{3} s_{4}}{3} - \frac{\sqrt{3} s_{5}}{6} - \frac{\sqrt{3} s_{6}}{6}\end{matrix}\right] $ )
\item orbital of E2g with energy = $\alpha_{s} - \beta_{s}$ \\
                            ( $\left[\begin{matrix}0\\1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g}\end{array}\right] = \left[\begin{matrix}\frac{s_{2}}{2} - \frac{s_{3}}{2} + \frac{s_{5}}{2} - \frac{s_{6}}{2}\end{matrix}\right] $ )
\item orbital of B1u with energy = $\alpha_{s} - 2 \beta_{s}$ \\
                            ( $\left[\begin{matrix}1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B1u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{6} s_{1}}{6} - \frac{\sqrt{6} s_{2}}{6} + \frac{\sqrt{6} s_{3}}{6} - \frac{\sqrt{6} s_{4}}{6} + \frac{\sqrt{6} s_{5}}{6} - \frac{\sqrt{6} s_{6}}{6}\end{matrix}\right] $ )
\end{itemize}
...
$$E_{dispersion} =\frac{32 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s} - 2 \beta + 2 \beta_{s}\right)} + \frac{32 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s}\right)}$$
 \item State: A = (2, 1, 1, 1, 1, 0) $\leftrightarrow$ B = [2, 2, 2, 0, 0, 0] 
$$E_{dispersion} =\frac{32 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s} - 2 \beta + 2 \beta_{s}\right)} + \frac{32 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s}\right)}$$
 \item State: A = (2, 1, 2, 0, 1, 0) $\leftrightarrow$ B = (2, 1, 2, 0, 1, 0) 
$$E_{dispersion} =\frac{4 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s} + 2 \beta - 2 \beta_{s}\right)} + \frac{36 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s} - 2 \beta + 2 \beta_{s}\right)} + \frac{24 \delta^{4}}{r^{6} \left(- 2 \alpha + 2 \alpha_{s}\right)}$$
