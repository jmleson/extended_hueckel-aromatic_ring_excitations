...
$$\mathsf{\Gamma}_{red} = \,7 E\;; \,-3 C2\;; \,-7 \sigma v(xz)\;; \,3 \sigma v(yz)\;$$
...
Put together these SALCs form the following Hamilton matrices:
     $$ H_{B2}= \begin{pmatrix}\tilde{\alpha} & \sqrt{2} \tilde{\beta} & 0 & 0 & \tilde{\beta}_{Cl}\\\sqrt{2} \tilde{\beta} & \tilde{\alpha} & \tilde{\beta} & 0 & 0\\0 & \tilde{\beta} & \tilde{\alpha} & \sqrt{2} \tilde{\beta} & 0\\0 & 0 & \sqrt{2} \tilde{\beta} & \tilde{\alpha} & 0\\\tilde{\beta}_{Cl} & 0 & 0 & 0 & \tilde{\alpha}_{Cl}\end{pmatrix}$$ 
     $$ H_{A2}= \begin{pmatrix}\tilde{\alpha} & \tilde{\beta}\\\tilde{\beta} & \tilde{\alpha}\end{pmatrix}$$ 
...
( 
$$
\begin{pmatrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2}\end{pmatrix} * \left(\begin{array}{c}\text{1. SALC in A2} \\ \text{2. SALC in A2}\end{array}\right) = \begin{pmatrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2}\end{pmatrix} * \begin{pmatrix}\frac{\sqrt{2} \text{p}_{2}}{2} - \frac{\sqrt{2} \text{p}_{6}}{2}\\\frac{\sqrt{2} \text{p}_{3}}{2} - \frac{\sqrt{2} \text{p}_{5}}{2}\end{pmatrix} 
...
( 
$$
\begin{pmatrix}?_{1} Norm^{2} & ?_{2} Norm^{2} & ?_{3} Norm^{2} & ?_{4} Norm^{2} & ?_{5} Norm^{2}\end{pmatrix} * \left(\begin{array}{c}\text{1. SALC in B2} \\ \text{2. SALC in B2} \\ \text{3. SALC in B2} \\ \text{4. SALC in B2} \\ \text{5. SALC in B2}\end{array}\right) = \begin{pmatrix}?_{1} Norm^{2} & ?_{2} Norm^{2} & ?_{3} Norm^{2} & ?_{4} Norm^{2} & ?_{5} Norm^{2}\end{pmatrix} * \begin{pmatrix}\text{p}_{1}\\\frac{\sqrt{2} \text{p}_{2}}{2} + \frac{\sqrt{2} \text{p}_{6}}{2}\\\frac{\sqrt{2} \text{p}_{3}}{2} + \frac{\sqrt{2} \text{p}_{5}}{2}\\\text{p}_{4}\\\text{p}_{7}\end{pmatrix} 
...
\end{itemize}
Put together these SALCs form the following Hamilton matrices:
     $$ H_{A1}= \begin{pmatrix}\tilde{\alpha}_{s} & \sqrt{2} \tilde{\beta}_{s} & 0 & 0 & beta_{\text{s}_Cl}\\\sqrt{2} \tilde{\beta}_{s} & \tilde{\alpha}_{s} & \tilde{\beta}_{s} & 0 & 0\\0 & \tilde{\beta}_{s} & \tilde{\alpha}_{s} & \sqrt{2} \tilde{\beta}_{s} & 0\\0 & 0 & \sqrt{2} \tilde{\beta}_{s} & \tilde{\alpha}_{s} & 0\\tilde{\beta}_{\text{s}_Cl} & 0 & 0 & 0 & alpha_{\text{s}_Cl}\end{pmatrix}$$ 
     $$ H_{B1}= \begin{pmatrix}\tilde{\alpha}_{s} & \tilde{\beta}_{s}\\\tilde{\beta}_{s} & \tilde{\alpha}_{s}\end{pmatrix}$$ 
...
( 
$$
\begin{pmatrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2}\end{pmatrix} * \left(\begin{array}{c}\text{1. SALC in B1} \\ \text{2. SALC in B1}\end{array}\right) = \begin{pmatrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2}\end{pmatrix} * \begin{pmatrix}\frac{\sqrt{2} \text{s}_{2}}{2} - \frac{\sqrt{2} \text{s}_{6}}{2}\\\frac{\sqrt{2} \text{s}_{3}}{2} - \frac{\sqrt{2} \text{s}_{5}}{2}\end{pmatrix} 
...
( 
$$
\begin{pmatrix}?_{1} Norm^{2} & ?_{2} Norm^{2} & ?_{3} Norm^{2} & ?_{4} Norm^{2} & ?_{5} Norm^{2}\end{pmatrix} * \left(\begin{array}{c}\text{1. SALC in A1} \\ \text{2. SALC in A1} \\ \text{3. SALC in A1} \\ \text{4. SALC in A1} \\ \text{5. SALC in A1}\end{array}\right) = \begin{pmatrix}?_{1} Norm^{2} & ?_{2} Norm^{2} & ?_{3} Norm^{2} & ?_{4} Norm^{2} & ?_{5} Norm^{2}\end{pmatrix} * \begin{pmatrix}\text{s}_{1}\\\frac{\sqrt{2} \text{s}_{2}}{2} + \frac{\sqrt{2} \text{s}_{6}}{2}\\\frac{\sqrt{2} \text{s}_{3}}{2} + \frac{\sqrt{2} \text{s}_{5}}{2}\\\text{s}_{4}\\\text{s}_{7}\end{pmatrix} 
