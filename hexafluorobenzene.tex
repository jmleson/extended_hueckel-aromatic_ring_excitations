...
$$\mathsf{\Gamma}_{red} = \,12 E\;\oplus{}\,-4 C'2\;\oplus{}\,-12 \sigma h\;\oplus{}\,4 \sigma v\;$$
...
Put together these SALCs form the following Hamilton matrices:
     $$ H_{B2g}= \left[\begin{bmatrix}\tilde{\alpha} - 2 \tilde{\beta} & 0\\0 & \tilde{\alpha}_{F}\end{bmatrix}\right]$$ 
     $$ H_{E1g}= \left[\begin{bmatrix}\tilde{\alpha} + \tilde{\beta} & \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & - \frac{\tilde{\alpha}}{2} - \frac{\tilde{\beta}}{2} & 0\\\frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & \tilde{\alpha} + \tilde{\beta} & \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & 0\\- \frac{\tilde{\alpha}}{2} - \frac{\tilde{\beta}}{2} & \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & \tilde{\alpha} + \tilde{\beta} & 0\\0 & 0 & 0 & \tilde{\alpha}_{F}\end{bmatrix}\right]$$ 
     $$ H_{A2u}= \left[\begin{bmatrix}\tilde{\alpha} + 2 \tilde{\beta} & 6 \tilde{\beta}_{F}\\6 \tilde{\beta}_{F} & \tilde{\alpha}_{F}\end{bmatrix}\right]$$ 
     $$ H_{E2u}= \left[\begin{bmatrix}\tilde{\alpha} - \tilde{\beta} & - \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & - \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & 0\\- \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & \tilde{\alpha} - \tilde{\beta} & - \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & 0\\- \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & - \frac{\tilde{\alpha}}{2} + \frac{\tilde{\beta}}{2} & \tilde{\alpha} - \tilde{\beta} & 0\\0 & 0 & 0 & \tilde{\alpha}_{F}\end{bmatrix}\right]$$ 
...
( 
$$
\left[\begin{matrix}- \frac{12 \tilde{\beta}_{F}}{\sqrt{144 \left|{\frac{\tilde{\beta}_{F}}{\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}}}\right|^{2} + 1} \left(\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}\right)} & \frac{1}{\sqrt{144 \left|{\frac{\tilde{\beta}_{F}}{\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}}}\right|^{2} + 1}}\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A2u} \\ \text{2. SALC in A2u}\end{array}\right] = \left[\begin{matrix}- \frac{12 \tilde{\beta}_{F}}{\sqrt{144 \left|{\frac{\tilde{\beta}_{F}}{\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}}}\right|^{2} + 1} \left(\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}\right)} & \frac{1}{\sqrt{144 \left|{\frac{\tilde{\beta}_{F}}{\tilde{\alpha} - \tilde{\alpha}_{F} + 2 \tilde{\beta} + \sqrt{\tilde{\alpha}^{2} - 2 \tilde{\alpha} \tilde{\alpha}_{F} + 4 \tilde{\alpha} \tilde{\beta} + \tilde{\alpha}_{F}^{2} - 4 \tilde{\alpha}_{F} \tilde{\beta} + 4 \tilde{\beta}^{2} + 144 \tilde{\beta}_{F}^{2}}}}\right|^{2} + 1}}\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{p}_{1}}{6} + \frac{\sqrt{6} \text{p}_{2}}{6} + \frac{\sqrt{6} \text{p}_{3}}{6} + \frac{\sqrt{6} \text{p}_{4}}{6} + \frac{\sqrt{6} \text{p}_{5}}{6} + \frac{\sqrt{6} \text{p}_{6}}{6}\\\frac{\sqrt{6} \text{p}_{10}}{6} + \frac{\sqrt{6} \text{p}_{11}}{6} + \frac{\sqrt{6} \text{p}_{12}}{6} + \frac{\sqrt{6} \text{p}_{7}}{6} + \frac{\sqrt{6} \text{p}_{8}}{6} + \frac{\sqrt{6} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g} \\ \text{3. SALC in E1g} \\ \text{4. SALC in E1g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} + \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} + \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{3}\\- \frac{\sqrt{3} \text{p}_{10}}{6} - \frac{\sqrt{3} \text{p}_{11}}{3} - \frac{\sqrt{3} \text{p}_{12}}{6} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{3} + \frac{\sqrt{3} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g} \\ \text{3. SALC in E1g} \\ \text{4. SALC in E1g}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} + \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} + \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{3}\\- \frac{\sqrt{3} \text{p}_{10}}{6} - \frac{\sqrt{3} \text{p}_{11}}{3} - \frac{\sqrt{3} \text{p}_{12}}{6} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{3} + \frac{\sqrt{3} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{3}}{3} & - \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g} \\ \text{3. SALC in E1g} \\ \text{4. SALC in E1g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3}}{3} & - \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} + \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} + \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{3}\\- \frac{\sqrt{3} \text{p}_{10}}{6} - \frac{\sqrt{3} \text{p}_{11}}{3} - \frac{\sqrt{3} \text{p}_{12}}{6} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{3} + \frac{\sqrt{3} \text{p}_{9}}{6}\end{matrix}\right] 
 $$ $$ = 0 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1g} \\ \text{2. SALC in E1g} \\ \text{3. SALC in E1g} \\ \text{4. SALC in E1g}\end{array}\right] = \left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} + \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{6}\\\frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} + \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} + \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{3}\\- \frac{\sqrt{3} \text{p}_{10}}{6} - \frac{\sqrt{3} \text{p}_{11}}{3} - \frac{\sqrt{3} \text{p}_{12}}{6} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{3} + \frac{\sqrt{3} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B2g} \\ \text{2. SALC in B2g}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{p}_{1}}{6} - \frac{\sqrt{6} \text{p}_{2}}{6} + \frac{\sqrt{6} \text{p}_{3}}{6} - \frac{\sqrt{6} \text{p}_{4}}{6} + \frac{\sqrt{6} \text{p}_{5}}{6} - \frac{\sqrt{6} \text{p}_{6}}{6}\\- \frac{\sqrt{6} \text{p}_{10}}{6} + \frac{\sqrt{6} \text{p}_{11}}{6} - \frac{\sqrt{6} \text{p}_{12}}{6} + \frac{\sqrt{6} \text{p}_{7}}{6} - \frac{\sqrt{6} \text{p}_{8}}{6} + \frac{\sqrt{6} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B2g} \\ \text{2. SALC in B2g}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{p}_{1}}{6} - \frac{\sqrt{6} \text{p}_{2}}{6} + \frac{\sqrt{6} \text{p}_{3}}{6} - \frac{\sqrt{6} \text{p}_{4}}{6} + \frac{\sqrt{6} \text{p}_{5}}{6} - \frac{\sqrt{6} \text{p}_{6}}{6}\\- \frac{\sqrt{6} \text{p}_{10}}{6} + \frac{\sqrt{6} \text{p}_{11}}{6} - \frac{\sqrt{6} \text{p}_{12}}{6} + \frac{\sqrt{6} \text{p}_{7}}{6} - \frac{\sqrt{6} \text{p}_{8}}{6} + \frac{\sqrt{6} \text{p}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u} \\ \text{3. SALC in E2u} \\ \text{4. SALC in E2u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} + \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} - \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{3}\\\frac{\sqrt{3} \text{p}_{10}}{6} + \frac{\sqrt{3} \text{p}_{11}}{6} - \frac{\sqrt{3} \text{p}_{12}}{3} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{6} - \frac{\sqrt{3} \text{p}_{9}}{3}\end{matrix}\right] 
 $$ $$ = 0 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u} \\ \text{3. SALC in E2u} \\ \text{4. SALC in E2u}\end{array}\right] = \left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} + \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} - \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{3}\\\frac{\sqrt{3} \text{p}_{10}}{6} + \frac{\sqrt{3} \text{p}_{11}}{6} - \frac{\sqrt{3} \text{p}_{12}}{3} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{6} - \frac{\sqrt{3} \text{p}_{9}}{3}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u} \\ \text{3. SALC in E2u} \\ \text{4. SALC in E2u}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} + \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} - \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{3}\\\frac{\sqrt{3} \text{p}_{10}}{6} + \frac{\sqrt{3} \text{p}_{11}}{6} - \frac{\sqrt{3} \text{p}_{12}}{3} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{6} - \frac{\sqrt{3} \text{p}_{9}}{3}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(- \text{p}_{1} + \text{p}_{2} - \text{p}_{4} + \text{p}_{5}\right)}{4} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2u} \\ \text{2. SALC in E2u} \\ \text{3. SALC in E2u} \\ \text{4. SALC in E2u}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{p}_{1}}{3} - \frac{\sqrt{3} \text{p}_{2}}{6} - \frac{\sqrt{3} \text{p}_{3}}{6} + \frac{\sqrt{3} \text{p}_{4}}{3} - \frac{\sqrt{3} \text{p}_{5}}{6} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} + \frac{\sqrt{3} \text{p}_{2}}{3} - \frac{\sqrt{3} \text{p}_{3}}{6} - \frac{\sqrt{3} \text{p}_{4}}{6} + \frac{\sqrt{3} \text{p}_{5}}{3} - \frac{\sqrt{3} \text{p}_{6}}{6}\\- \frac{\sqrt{3} \text{p}_{1}}{6} - \frac{\sqrt{3} \text{p}_{2}}{6} + \frac{\sqrt{3} \text{p}_{3}}{3} - \frac{\sqrt{3} \text{p}_{4}}{6} - \frac{\sqrt{3} \text{p}_{5}}{6} + \frac{\sqrt{3} \text{p}_{6}}{3}\\\frac{\sqrt{3} \text{p}_{10}}{6} + \frac{\sqrt{3} \text{p}_{11}}{6} - \frac{\sqrt{3} \text{p}_{12}}{3} + \frac{\sqrt{3} \text{p}_{7}}{6} + \frac{\sqrt{3} \text{p}_{8}}{6} - \frac{\sqrt{3} \text{p}_{9}}{3}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(- \text{p}_{1} + \text{p}_{3} - \text{p}_{4} + \text{p}_{6}\right)}{4} 
 $$ 
 )
...
\end{itemize}
Put together these SALCs form the following Hamilton matrices:
     $$ H_{A1g}= \left[\begin{bmatrix}\tilde{\alpha}_{s} + 2 \tilde{\beta}_{s} & 6 beta_{\text{s}_F}\\6 beta_{\text{s}_F} & alpha_{\text{s}_F}\end{bmatrix}\right]$$ 
     $$ H_{E2g}= \left[\begin{bmatrix}\tilde{\alpha}_{s} - \tilde{\beta}_{s} & - \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & - \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & 0\\- \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & \tilde{\alpha}_{s} - \tilde{\beta}_{s} & - \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & 0\\- \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & - \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & \tilde{\alpha}_{s} - \tilde{\beta}_{s} & 0\\0 & 0 & 0 & alpha_{\text{s}_F}\end{bmatrix}\right]$$ 
     $$ H_{B1u}= \left[\begin{bmatrix}\tilde{\alpha}_{s} - 2 \tilde{\beta}_{s} & 0\\0 & alpha_{\text{s}_F}\end{bmatrix}\right]$$ 
     $$ H_{E1u}= \left[\begin{bmatrix}\tilde{\alpha}_{s} + \tilde{\beta}_{s} & \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & - \frac{\tilde{\alpha}_{s}}{2} - \frac{\tilde{\beta}_{s}}{2} & 0\\\frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & \tilde{\alpha}_{s} + \tilde{\beta}_{s} & \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & 0\\- \frac{\tilde{\alpha}_{s}}{2} - \frac{\tilde{\beta}_{s}}{2} & \frac{\tilde{\alpha}_{s}}{2} + \frac{\tilde{\beta}_{s}}{2} & \tilde{\alpha}_{s} + \tilde{\beta}_{s} & 0\\0 & 0 & 0 & alpha_{\text{s}_F}\end{bmatrix}\right]$$ 
...
( 
$$
\left[\begin{matrix}- \frac{12 beta_{\text{s}_F}}{\sqrt{144 \left|{\frac{beta_{\text{s}_F}}{\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}}}\right|^{2} + 1} \left(\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}\right)} & \frac{1}{\sqrt{144 \left|{\frac{beta_{\text{s}_F}}{\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}}}\right|^{2} + 1}}\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in A1g} \\ \text{2. SALC in A1g}\end{array}\right] = \left[\begin{matrix}- \frac{12 beta_{\text{s}_F}}{\sqrt{144 \left|{\frac{beta_{\text{s}_F}}{\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}}}\right|^{2} + 1} \left(\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}\right)} & \frac{1}{\sqrt{144 \left|{\frac{beta_{\text{s}_F}}{\tilde{\alpha}_{s} - alpha_{\text{s}_F} + 2 \tilde{\beta}_{s} + \sqrt{\tilde{\alpha}_{s}^{2} - 2 \tilde{\alpha}_{s} alpha_{\text{s}_F} + 4 \tilde{\alpha}_{s} \tilde{\beta}_{s} + alpha_{\text{s}_F}^{2} - 4 alpha_{\text{s}_F} \tilde{\beta}_{s} + 4 \tilde{\beta}_{s}^{2} + 144 beta_{\text{s}_F}^{2}}}}\right|^{2} + 1}}\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{s}_{1}}{6} + \frac{\sqrt{6} \text{s}_{2}}{6} + \frac{\sqrt{6} \text{s}_{3}}{6} + \frac{\sqrt{6} \text{s}_{4}}{6} + \frac{\sqrt{6} \text{s}_{5}}{6} + \frac{\sqrt{6} \text{s}_{6}}{6}\\\frac{\sqrt{6} \text{s}_{10}}{6} + \frac{\sqrt{6} \text{s}_{11}}{6} + \frac{\sqrt{6} \text{s}_{12}}{6} + \frac{\sqrt{6} \text{s}_{7}}{6} + \frac{\sqrt{6} \text{s}_{8}}{6} + \frac{\sqrt{6} \text{s}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u} \\ \text{3. SALC in E1u} \\ \text{4. SALC in E1u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} + \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} + \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{3}\\- \frac{\sqrt{3} \text{s}_{10}}{6} - \frac{\sqrt{3} \text{s}_{11}}{3} - \frac{\sqrt{3} \text{s}_{12}}{6} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{3} + \frac{\sqrt{3} \text{s}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u} \\ \text{3. SALC in E1u} \\ \text{4. SALC in E1u}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} + \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} + \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{3}\\- \frac{\sqrt{3} \text{s}_{10}}{6} - \frac{\sqrt{3} \text{s}_{11}}{3} - \frac{\sqrt{3} \text{s}_{12}}{6} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{3} + \frac{\sqrt{3} \text{s}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{3}}{3} & - \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u} \\ \text{3. SALC in E1u} \\ \text{4. SALC in E1u}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3}}{3} & - \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} + \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} + \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{3}\\- \frac{\sqrt{3} \text{s}_{10}}{6} - \frac{\sqrt{3} \text{s}_{11}}{3} - \frac{\sqrt{3} \text{s}_{12}}{6} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{3} + \frac{\sqrt{3} \text{s}_{9}}{6}\end{matrix}\right] 
 $$ $$ = 0 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E1u} \\ \text{2. SALC in E1u} \\ \text{3. SALC in E1u} \\ \text{4. SALC in E1u}\end{array}\right] = \left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} + \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{6}\\\frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} + \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} + \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{3}\\- \frac{\sqrt{3} \text{s}_{10}}{6} - \frac{\sqrt{3} \text{s}_{11}}{3} - \frac{\sqrt{3} \text{s}_{12}}{6} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{3} + \frac{\sqrt{3} \text{s}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}\frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g} \\ \text{3. SALC in E2g} \\ \text{4. SALC in E2g}\end{array}\right] = \left[\begin{matrix}\frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} + \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} - \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{3}\\\frac{\sqrt{3} \text{s}_{10}}{6} + \frac{\sqrt{3} \text{s}_{11}}{6} - \frac{\sqrt{3} \text{s}_{12}}{3} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{6} - \frac{\sqrt{3} \text{s}_{9}}{3}\end{matrix}\right] 
 $$ $$ = 0 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g} \\ \text{3. SALC in E2g} \\ \text{4. SALC in E2g}\end{array}\right] = \left[\begin{matrix}0 & 0 & 0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} + \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} - \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{3}\\\frac{\sqrt{3} \text{s}_{10}}{6} + \frac{\sqrt{3} \text{s}_{11}}{6} - \frac{\sqrt{3} \text{s}_{12}}{3} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{6} - \frac{\sqrt{3} \text{s}_{9}}{3}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g} \\ \text{3. SALC in E2g} \\ \text{4. SALC in E2g}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} & 0 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} + \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} - \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{3}\\\frac{\sqrt{3} \text{s}_{10}}{6} + \frac{\sqrt{3} \text{s}_{11}}{6} - \frac{\sqrt{3} \text{s}_{12}}{3} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{6} - \frac{\sqrt{3} \text{s}_{9}}{3}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(- \text{s}_{1} + \text{s}_{2} - \text{s}_{4} + \text{s}_{5}\right)}{4} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in E2g} \\ \text{2. SALC in E2g} \\ \text{3. SALC in E2g} \\ \text{4. SALC in E2g}\end{array}\right] = \left[\begin{matrix}- \frac{\sqrt{2}}{2} & 0 & \frac{\sqrt{2}}{2} & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{3} \text{s}_{1}}{3} - \frac{\sqrt{3} \text{s}_{2}}{6} - \frac{\sqrt{3} \text{s}_{3}}{6} + \frac{\sqrt{3} \text{s}_{4}}{3} - \frac{\sqrt{3} \text{s}_{5}}{6} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} + \frac{\sqrt{3} \text{s}_{2}}{3} - \frac{\sqrt{3} \text{s}_{3}}{6} - \frac{\sqrt{3} \text{s}_{4}}{6} + \frac{\sqrt{3} \text{s}_{5}}{3} - \frac{\sqrt{3} \text{s}_{6}}{6}\\- \frac{\sqrt{3} \text{s}_{1}}{6} - \frac{\sqrt{3} \text{s}_{2}}{6} + \frac{\sqrt{3} \text{s}_{3}}{3} - \frac{\sqrt{3} \text{s}_{4}}{6} - \frac{\sqrt{3} \text{s}_{5}}{6} + \frac{\sqrt{3} \text{s}_{6}}{3}\\\frac{\sqrt{3} \text{s}_{10}}{6} + \frac{\sqrt{3} \text{s}_{11}}{6} - \frac{\sqrt{3} \text{s}_{12}}{3} + \frac{\sqrt{3} \text{s}_{7}}{6} + \frac{\sqrt{3} \text{s}_{8}}{6} - \frac{\sqrt{3} \text{s}_{9}}{3}\end{matrix}\right] 
 $$ $$ = \frac{\sqrt{6} \left(- \text{s}_{1} + \text{s}_{3} - \text{s}_{4} + \text{s}_{6}\right)}{4} 
 $$ 
 )
...
( 
$$
\left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B1u} \\ \text{2. SALC in B1u}\end{array}\right] = \left[\begin{matrix}0 & 1\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{s}_{1}}{6} - \frac{\sqrt{6} \text{s}_{2}}{6} + \frac{\sqrt{6} \text{s}_{3}}{6} - \frac{\sqrt{6} \text{s}_{4}}{6} + \frac{\sqrt{6} \text{s}_{5}}{6} - \frac{\sqrt{6} \text{s}_{6}}{6}\\- \frac{\sqrt{6} \text{s}_{10}}{6} + \frac{\sqrt{6} \text{s}_{11}}{6} - \frac{\sqrt{6} \text{s}_{12}}{6} + \frac{\sqrt{6} \text{s}_{7}}{6} - \frac{\sqrt{6} \text{s}_{8}}{6} + \frac{\sqrt{6} \text{s}_{9}}{6}\end{matrix}\right] 
...
( 
$$
\left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{array}{c}\text{1. SALC in B1u} \\ \text{2. SALC in B1u}\end{array}\right] = \left[\begin{matrix}1 & 0\end{matrix}\right] * \left[\begin{matrix}\frac{\sqrt{6} \text{s}_{1}}{6} - \frac{\sqrt{6} \text{s}_{2}}{6} + \frac{\sqrt{6} \text{s}_{3}}{6} - \frac{\sqrt{6} \text{s}_{4}}{6} + \frac{\sqrt{6} \text{s}_{5}}{6} - \frac{\sqrt{6} \text{s}_{6}}{6}\\- \frac{\sqrt{6} \text{s}_{10}}{6} + \frac{\sqrt{6} \text{s}_{11}}{6} - \frac{\sqrt{6} \text{s}_{12}}{6} + \frac{\sqrt{6} \text{s}_{7}}{6} - \frac{\sqrt{6} \text{s}_{8}}{6} + \frac{\sqrt{6} \text{s}_{9}}{6}\end{matrix}\right] 
